...
func (c *distanceAggregatorClient) GetInvoice(ctx context.Context, in *GetInvoiceRequest, opts ...grpc.CallOption) (*InvoiceResponse, error) {
...
func (UnimplementedDistanceAggregatorServer) GetInvoice(context.Context, *GetInvoiceRequest) (*InvoiceResponse, error) {
